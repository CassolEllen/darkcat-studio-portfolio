...
import { HalftoneStar } from './ChromeElements'
...
const projects = [
  {
    ...
    type: 'Product Design',
    category: 'APP DESIGN',
    description: 'Um app pra tirar o planejamento de viagens em grupo do caos das conversas de WhatsApp e colocar direto na estrada — do primeiro convite ao memorial da viagem. 16+ telas · design system · Figma & React.',
    image: '/01-capa.png',
...
export default function Projects() {
  return (
    <section id="work" style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      {/* section header */}
      <div style={{ padding: '40px 40px 20px', display: 'flex', alignItems: 'flex-end', gap: 16 }}>
        <motion.div
